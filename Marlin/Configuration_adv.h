...
#define CUSTOM_MENU_MAIN
  ...
  #define MAIN_MENU_ITEM_1_DESC "T0"
  #define MAIN_MENU_ITEM_1_GCODE "T0"
  //#define MAIN_MENU_ITEM_1_CONFIRM          // Show a confirmation dialog before this action

  #define MAIN_MENU_ITEM_2_DESC "T1"
  #define MAIN_MENU_ITEM_2_GCODE "T1"
  //#define MAIN_MENU_ITEM_2_CONFIRM

  #define MAIN_MENU_ITEM_3_DESC "T2"
  #define MAIN_MENU_ITEM_3_GCODE "T2"
  //#define MAIN_MENU_ITEM_3_CONFIRM

  #define MAIN_MENU_ITEM_4_DESC "T3"
